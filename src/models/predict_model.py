...
def predict_model(
    ...
    Args:
        ...
        output_submission_path (str): Путь для сохранения выходного файла submission (.csv)
    ...
    pairs_ids_df = pair_feautures_df[["id_1", "id_2"]]
    ...
    submission_pred.to_csv(output_submission_path, ignore_index=True)
